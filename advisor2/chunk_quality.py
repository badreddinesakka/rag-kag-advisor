...
Les deux dernières demandent des embeddings (modèle fourni par l'appelant) : elles sont
    ...
    for cand in candidates:
        ...
        if not chunks:
            msg = ("aucun morceau produit — pour la stratégie « semantic », "
                   "c'est presque toujours Ollama injoignable, ou aucun modèle "
                   "d'embedding fourni (CHUNKER_EMBED_MODEL ou --embed-model)")
